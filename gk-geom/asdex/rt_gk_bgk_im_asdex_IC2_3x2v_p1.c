...
create_ctx(void)
{
  ...
  double q0 = 4.67;   // Calculated by Akash Shukla
  double r0 = 0.5;   
  ...
  int Ny = 32; // Number of cells in y.
...
main(int argc, char **argv)
{
  ...
  struct gkyl_gyrokinetic_species elc = {
    ...
    //  .file_name = "gk_bgk_im_asdex_IC2_2x2v_p1-elc_20.gkyl",
    //},
    ...
    .num_diag_moments = 6,
    .diag_moments = { "M1", "M2", "M2par", "M2perp", "BiMaxwellianMoments", "MaxwellianMoments" },
  };
  ...
  struct gkyl_gyrokinetic_species ion = {
    ...
    //.init_from_file = {
    //  .type = GKYL_IC_IMPORT_F,
    //  .file_name = "gk_bgk_im_asdex_IC2_2x2v_p1-ion_20.gkyl",
    //},
  ...
  // GK app
  struct gkyl_gk gk = {
    .name = "gk_bgk_im_asdex_IC2_3x2v_p1",

    .cdim = ctx.cdim, .vdim = ctx.vdim,
    .lower = { 0.154, -ctx.Ly/2.0, -ctx.Lz/2.0 },
    .upper = { 0.170, ctx.Ly/2.0, ctx.Lz/2.0 },
