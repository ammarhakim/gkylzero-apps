...
struct gk_app_ctx create_ctx(struct gkyl_app_args *app_args)
{
  // Extract variables from command line arguments.
  // double Pin, diffusionD;
  double nuFrac;
  sscanf(app_args->opt_args, "nuFrac=%lf", &nuFrac);
  ...
  char eqdsk_file[128] = "../33341_1.775.eqdsk";
...
main(int argc, char **argv)
{
  ...
  struct gk_app_ctx ctx = create_ctx(&app_args); // context for init functions
...
//    },
  ...
  struct gkyl_gk app_inp = {
    .name = "gk_bgk_im_asdex_low_adapt_3x2v_p1",
