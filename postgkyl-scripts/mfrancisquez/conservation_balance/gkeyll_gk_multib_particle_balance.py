...
data_dir        = './gk_multib_step_2x2v_p1/cfl1p0/' #[ Where Gkeyll data is located.
simulation_name = 'gk_multib_step_2x2v_p1' #[ Name of Gkeyll simulation.
...
if plot_balance:
  ...
  #[ Number of blocks.
  fdot_file_list = glob.glob(data_dir + '/' + simulation_name + '_b*-' + species_name + '_fdot_integrated_moms.gkyl')
